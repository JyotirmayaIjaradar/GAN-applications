...
class pix2pix_GeneratorUNet(nn.Module):
    def __init__(self, in_channels=3, out_channels=3):
        super(pix2pix_GeneratorUNet, self).__init__()
...
class Dualgan_Generator(nn.Module):
    def __init__(self, channels=3):
        super(Dualgan_Generator, self).__init__()
...
class Dualgan_Discriminator(nn.Module):
    def __init__(self, in_channels=3):
        super(Dualgan_Discriminator, self).__init__()
